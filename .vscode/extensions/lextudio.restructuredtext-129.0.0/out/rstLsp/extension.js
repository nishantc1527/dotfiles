...
function activate(context, logger, disabled) {
    if (disabled) {
        return;
    }
    ...
    if (serverModule != null) {
        ...
        let disposable = new vscode_languageclient_1.LanguageClient('restructuredtext', 'reStructuredText Language Server', serverOptions, clientOptions).start();
