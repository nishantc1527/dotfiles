source $NVIM_HOME/settings/plugconfig/airline.vim
source $NVIM_HOME/settings/plugconfig/ultisnips.vim
source $NVIM_HOME/settings/plugconfig/ale.vim
source $NVIM_HOME/settings/plugconfig/autoformat.vim
source $NVIM_HOME/settings/plugconfig/closetag.vim
